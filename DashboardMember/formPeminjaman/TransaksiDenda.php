...
<body>
   ...
   <main>
    <div class="container grid">
      <h1 class="title__m-m">Penalty Data</h1>
        ...
        <tbody>
          <?php foreach ($dataDenda as $item) : ?>
            <tr>
              ...
              <td class="td-m"> 
                <a class="btn btn-danger" href="formBayarDenda.php?id=<?= $item["id_pengembalian"]; ?>">Bayar</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
