...
<head>
   ...
   <title>Z - Library | Borrowing</title>
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($dataPinjam as $item) : ?>
                        <tr>
                            <td class="td-m"><?= $item["id_peminjaman"]; ?></td>
                            ...
                            <td class="td-m"><?= $item["tgl_peminjaman"]; ?></td>
                            <td class="td-m"><?= $item["tgl_pengembalian"]; ?></td>
                            <td class="td-m">
                                <a class="btn btn-danger" href="pengembalianBuku.php?id=<?= $item["id_peminjaman"]; ?>"><i class="ri-arrow-go-back-line"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
